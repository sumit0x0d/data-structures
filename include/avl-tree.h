...
DS_PUBLIC_API
void AvlTree_TraversePreorder(AvlTree *tree, DS_FunctionTraverse fTraverse, DS_Data dUser);

DS_PUBLIC_API
void AvlTree_TraverseInorder(AvlTree *tree, DS_FunctionTraverse fTraverse, DS_Data dUser);

DS_PUBLIC_API
void AvlTree_TraversePostorder(AvlTree *tree, DS_FunctionTraverse fTraverse, DS_Data dUser);

DS_PUBLIC_API
void AvlTree_TraverseLevelorder(AvlTree *tree, DS_FunctionTraverse fTraverse, DS_Data dUser);
