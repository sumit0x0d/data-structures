...
DATA_STRUCTURES_API
DS_Generic Array_PatternSearchNaive(const Array array, const DS_Generic pattern, DS_Size pattern_size);
...
DATA_STRUCTURES_API
DS_Generic Array_PatternSearchKmp(const Array array, const DS_Generic pattern, DS_Size pattern_size);
