...
__attribute__((visibility("default")))
void BinaryTree_InsertLeft(BinaryTree this, BinaryTreeNode this_node, const void *data);

__attribute__((visibility("default")))
void BinaryTree_InsertRight(BinaryTree this, BinaryTreeNode this_node, const void *data);
