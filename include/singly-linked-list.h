...
DATA_STRUCTURES_API
SinglyLinkedListNode SinglyLinkedList_GetHead(SinglyLinkedList singly_linked_list);

DATA_STRUCTURES_API
SinglyLinkedListNode SinglyLinkedList_GetTail(SinglyLinkedList singly_linked_list);
