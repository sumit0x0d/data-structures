...
DS_PUBLIC_API
LinkedListNode *LinkedList_GetHead(LinkedList *list);

DS_PUBLIC_API
LinkedListNode *LinkedList_GetTail(LinkedList *list);
...
DS_PUBLIC_API
void LinkedList_Traverse(LinkedList *list, DS_FunctionTraverse fTraverse, DS_Data dUser);

DS_PUBLIC_API
LinkedListNode *LinkedList_Detect_Cycle(LinkedList *list);
