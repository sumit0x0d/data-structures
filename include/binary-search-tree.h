...
DS_API
BinarySearchTree BinarySearchTree_Create(DS_Size data_size, DS_CallbackCompare compare_callback,
...
DS_API
DS_Void BinarySearchTree_TraversePreorder(BinarySearchTree tree, DS_CallbackUnary unary_callback,
                                          DS_Generic unary_context);

DS_API
DS_Void BinarySearchTree_TraverseInorder(BinarySearchTree tree, DS_CallbackUnary unary_callback,
                                         DS_Generic unary_context);

DS_API
DS_Void BinarySearchTree_TraversePostorder(BinarySearchTree tree, DS_CallbackUnary unary_callback,
                                           DS_Generic unary_context);

DS_API
DS_Void BinarySearchTree_TraverseLevelorder(BinarySearchTree tree, DS_CallbackUnary unary_callback,
                                            DS_Generic unary_context);
