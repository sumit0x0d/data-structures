...
DATA_STRUCTURES_API
DS_Void BinarySearchTree_Insert(BinarySearchTree binary_search_tree, const DS_Generic data);

DATA_STRUCTURES_API
BinarySearchTreeNode BinarySearchTree_Search(BinarySearchTree binary_search_tree, const DS_Generic data);

DATA_STRUCTURES_API
DS_Void BinarySearchTree_Remove(BinarySearchTree binary_search_tree, const DS_Generic data);
