...
RedBlackTree *RedBlackTree_Create(size_t size,
   RedBlackTreeCompareCallback compare_callback)
{
   RedBlackTree *this;
      ...
      if (node->color == RED_BLACK_TREE_NODE_COLOR_RED) {
         if (node->parent->left == node) {
            if (!node->parent->right
               || (node->parent->right->color == RED_BLACK_TREE_NODE_COLOR_BLACK)) {
               _RotateRight(this, node);
            } else if (node->parent->right
               || (node->parent->right->color == RED_BLACK_TREE_NODE_COLOR_RED)) {
            }
         }
      }
      if (node->parent->left == node) {
         ...
         if ((node->color == RED_BLACK_TREE_NODE_COLOR_RED)
            && (!node->parent->left
            || (node->parent->left->color == RED_BLACK_TREE_NODE_COLOR_BLACK))) {
         ...
         if ((node->color == RED_BLACK_TREE_NODE_COLOR_RED)
            && (node->parent->left
            && (node->parent->left->color == RED_BLACK_TREE_NODE_COLOR_RED))) {
            node->parent->color = RED_BLACK_TREE_NODE_COLOR_BLACK;
         }
      }
